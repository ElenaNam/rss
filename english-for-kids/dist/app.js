...
/* harmony export */ });
const cards = [['Action (set A)', 'Action (set B)', 'Animal (set A)', 'Animal (set B)', 'Clothes', 'Emotions', 'Furniture', 'Colors'], [{
  word: 'cry',
  translation: 'плакать',
  image: 'img/cry.jpg',
...
/***/ "./src/components/categoryName.js":
/*!****************************************!*\
  !*** ./src/components/categoryName.js ***!
  \****************************************/
/*! namespace exports */
...
const showCategoryName = index => {
  ...
  categoryNameWrapper.innerHTML = `<span>${_cards__WEBPACK_IMPORTED_MODULE_1__.default[0][index]}</span>`;
  return categoryNameWrapper;
};

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (showCategoryName);
...
/* harmony import */ var _startGame__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./startGame */ "./src/components/startGame.js");
/* harmony import */ var _categoryName__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./categoryName */ "./src/components/categoryName.js");
...
const renderCategoryPage = (category, index, mode) => {
  ...
  if (mode === true) {
    ...
    _mainpage__WEBPACK_IMPORTED_MODULE_1__.container.appendChild(_startGame__WEBPACK_IMPORTED_MODULE_2__.default);
  } else {
    _cards__WEBPACK_IMPORTED_MODULE_0__.default[index].forEach(elem => {
      cardWrapper = document.createElement('a');
      cardWrapper.classList.add('card-wrapper');
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (renderCategoryPage);
...
/* harmony import */ var _categorypage__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./categorypage */ "./src/components/categorypage.js");
...
const renderHeader = () => {
  ...
  if (_cards__WEBPACK_IMPORTED_MODULE_0__.default[0][0] !== 'Main Page') {
    _cards__WEBPACK_IMPORTED_MODULE_0__.default[0].unshift('Main Page');
  }

  _cards__WEBPACK_IMPORTED_MODULE_0__.default[0].forEach((link, j) => {
    navLink = document.createElement('a');
    navLink.classList.add('burger-nav_link');

    if (j === _state__WEBPACK_IMPORTED_MODULE_1__.default.page) {
    ...
    navLink.addEventListener('click', e => {
      ...
      Array.from(e.currentTarget.parentNode.children).forEach((item, i) => {
        if (item === e.currentTarget) {
          ...
          _state__WEBPACK_IMPORTED_MODULE_1__.default.page = i;
        } else {
      ...
      if (e.target.textContent === 'Main Page') {
        _state__WEBPACK_IMPORTED_MODULE_1__.default.page = 0;
        (0,_mainpage__WEBPACK_IMPORTED_MODULE_2__.default)(_state__WEBPACK_IMPORTED_MODULE_1__.default.play);
      } else {
        (0,_categorypage__WEBPACK_IMPORTED_MODULE_3__.default)(e.target.textContent, _state__WEBPACK_IMPORTED_MODULE_1__.default.page, _state__WEBPACK_IMPORTED_MODULE_1__.default.play);
      }
    });
  });
  ...
  burgerMenuBtn.addEventListener('click', e => {
    ...
    Array.from(navLink.parentNode.children).forEach((item, v) => {
      if (v === _state__WEBPACK_IMPORTED_MODULE_1__.default.page) {
        item.classList.add('burger-nav_link-active');
      } else {
        item.classList.remove('burger-nav_link-active');
      }
  ...
  label.addEventListener('click', e => {
    if (label.textContent === 'Train') {
      ...
      _state__WEBPACK_IMPORTED_MODULE_1__.default.play = true;
    } else {
      label.textContent = 'Train';
      label.style.color = 'rgb(170, 38, 130)';
      _state__WEBPACK_IMPORTED_MODULE_1__.default.play = false;
    }

    console.log(`state.page ${_state__WEBPACK_IMPORTED_MODULE_1__.default.page}`);

    if (_state__WEBPACK_IMPORTED_MODULE_1__.default.page === 0) {
      (0,_mainpage__WEBPACK_IMPORTED_MODULE_2__.default)(_state__WEBPACK_IMPORTED_MODULE_1__.default.play);
    } else {
      ...
      Array.from(array).forEach((item, ind) => {
        if (ind === _state__WEBPACK_IMPORTED_MODULE_1__.default.page) {
          _mainpage__WEBPACK_IMPORTED_MODULE_2__.container.innerHTML = '';
          (0,_categorypage__WEBPACK_IMPORTED_MODULE_3__.default)(item.textContent, _state__WEBPACK_IMPORTED_MODULE_1__.default.page, _state__WEBPACK_IMPORTED_MODULE_1__.default.play);
        }
      });
    }
  });
...
/* harmony export */ });
/* harmony import */ var _cards__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./cards */ "./src/components/cards.js");
/* harmony import */ var _categorypage__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./categorypage */ "./src/components/categorypage.js");
...
const renderMainPage = mode => {
  ...
  let cardSection;
  let cardName;
  _cards__WEBPACK_IMPORTED_MODULE_0__.default.forEach((el, i) => {
    if (el !== _cards__WEBPACK_IMPORTED_MODULE_0__.default[0]) {
      cardWrapper = document.createElement('a');
      cardWrapper.classList.add('card-wrapper');
      ...
      cardName = document.createElement('span');
      cardName.classList.add('card-name');
      cardName.textContent = `${_cards__WEBPACK_IMPORTED_MODULE_0__.default[0][i]}`;
      cardSection.appendChild(cardName);
      cardWrapper.addEventListener('click', e => {
        container.innerHTML = '';
        _state__WEBPACK_IMPORTED_MODULE_2__.default.page = i;
        (0,_categorypage__WEBPACK_IMPORTED_MODULE_1__.default)(e.currentTarget.children[1].children[0].textContent, i, _state__WEBPACK_IMPORTED_MODULE_2__.default.play);
      });
    }
  });
};
      ...
      if (el.classList.contains('card-wrapper') && el.children[1].getAttribute('src') === _state__WEBPACK_IMPORTED_MODULE_1__.default.audioCurrent) {
        if (el.children[0].style.opacity !== '0.2') {
          ...
          if (arrAudioRandom.length === 1) {
            ...
            if (_state__WEBPACK_IMPORTED_MODULE_1__.default.error > 0) {
              resultWrapper.innerHTML = `
              <span>Сделано ошибок: ${_state__WEBPACK_IMPORTED_MODULE_1__.default.error}!</span>
            ...
            _mainpage__WEBPACK_IMPORTED_MODULE_2__.container.append(resultWrapper);
            setTimeout(() => {
              _state__WEBPACK_IMPORTED_MODULE_1__.default.play = false;
              _state__WEBPACK_IMPORTED_MODULE_1__.default.page = 0;
              _state__WEBPACK_IMPORTED_MODULE_1__.default.error = 0;
              /* state.audioCurrent = ''; */
        ...
        _state__WEBPACK_IMPORTED_MODULE_1__.default.error += 1;
      }
    });
  });
  repeatBtn.addEventListener('click', () => {
    new Audio(_state__WEBPACK_IMPORTED_MODULE_1__.default.audioCurrent).play();
    console.log('текущий не по клику но в цикле ' + _state__WEBPACK_IMPORTED_MODULE_1__.default.audioCurrent);
  });
};
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (startGameBtn);
...
window.onload = () => {
  ...
  (0,_components_mainpage__WEBPACK_IMPORTED_MODULE_2__.default)();
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "body {\r\n  box-sizing: border-box;\r\n  margin: 0;\r\n  padding: 0;\r\n  background-color: rgb(42, 134, 99);\r\n}\r\n\r\n/* Burger-menu */\r\n.lock {\r\n  overflow: hidden;\r\n}\r\n.header-wrapper {\r\n  position: relative;\r\n  margin: 0 auto;\r\n  z-index: 50;\r\n  display: flex;\r\n  justify-content: space-between;\r\n  width: 100%;\r\n  height: 12vh;\r\n  background-color: rgb(8, 77, 42);\r\n}\r\n\r\n.burger-menu_button {\r\n  position: absolute;\r\n  top: 13%;\r\n  left: 17%;\r\n  z-index: 20;\r\n  width: 80px;\r\n  height: 80px;\r\n  border-radius: 50%;\r\n  background-color: rgba(31, 168, 84, 0.5);\r\n  border: 1px solid rgb(16, 122, 126);\r\n}\r\n.burger-menu_button:hover {\r\n  cursor: pointer;\r\n  background-color: rgba(201, 211, 64, 0.7);\r\n  border: 1px solid rgb(10, 34, 110);\r\n}\r\n.burger-menu_lines::before,\r\n.burger-menu_lines::after,\r\n.burger-menu_lines {\r\n  position: absolute;\r\n  width: 50px;\r\n  height: 5px;\r\n  border-radius: 80%;\r\n  background-color: #1e2ebb;\r\n}\r\n.burger-menu_lines {\r\n  top: 50%;\r\n  left: 50%;\r\n  transform: translate(-50%, -50%);\r\n}\r\n.burger-menu_lines::before {\r\n  content: \"\";\r\n  top: -12px;\r\n}\r\n.burger-menu_lines::after {\r\n  content: \"\";\r\n  top: 12px;\r\n}\r\n.burger-menu_active .burger-menu_lines {\r\n  background-color: transparent;\r\n}\r\n.burger-menu_active .burger-menu_lines::before {\r\n  top: 0;\r\n  transform: rotate(45deg);\r\n  transition: 0.6s;\r\n}\r\n.burger-menu_active .burger-menu_lines::after {\r\n  top: 0;\r\n  transform: rotate(-45deg);\r\n  transition: 0.6s;\r\n}\r\n.burger-nav {\r\n  padding-top: 115px;\r\n  position: fixed;\r\n  top: 0;\r\n  z-index: 12;\r\n  display: flex;\r\n  flex-flow: column;\r\n  width: 300px;\r\n  height: 100vh;\r\n  background-color: #064b74;\r\n  border-radius: 10px;\r\n  overflow-y: auto;\r\n  left: -100%;\r\n  transition: 1s;\r\n}\r\n.burger-menu_active .burger-nav {\r\n  left: 0;\r\n  transform: rotate(720deg);\r\n  transition: 0.8s;\r\n}\r\n\r\n.burger-nav_link {\r\n  padding: 18px 35px;\r\n  font-size: 18px;\r\n  text-decoration: none;\r\n  text-transform: uppercase;\r\n  letter-spacing: 5px;\r\n  font-weight: 400;\r\n  color: #ffffff;\r\n}\r\n\r\n.burger-nav_link-active {\r\n  color: gold;\r\n  cursor: pointer;\r\n}\r\n.burger-nav_link:hover {\r\n  color: rgb(113, 171, 204);\r\n  cursor: pointer;\r\n}\r\n.burger-menu_overlay {\r\n  display: none;\r\n  position: fixed;\r\n  top: 0;\r\n  left: 0;\r\n  width: 100vw;\r\n  height: 100vh;\r\n  z-index: 10;\r\n}\r\n.burger-menu_active .burger-menu_overlay {\r\n  display: block;\r\n  background-color: rgba(0, 0, 0, 0.5);\r\n}\r\n\r\n/* Selector */\r\n.selector-wrapper {\r\n  position: absolute;\r\n  top: 42px;\r\n  right: 20%;\r\n  width: auto;\r\n}\r\n.input {\r\n  display: none;\r\n}\r\n.input:checked + .label::before {\r\n  right: -60px;\r\n}\r\n.label {\r\n  position: relative;\r\n  font-size: 1.5rem;\r\n  letter-spacing: 0.18rem;\r\n  font-weight: bold;\r\n  color: rgb(170, 38, 130);\r\n  text-shadow: 1px 1px black;\r\n  cursor: pointer;\r\n}\r\n.label::after {\r\n  position: absolute;\r\n  top: -4px;\r\n  right: -62px;\r\n  content: \"\";\r\n  width: 50px;\r\n  height: 25px;\r\n  background-color: wheat;\r\n  border: 1px solid blue;\r\n  border-radius: 15px;\r\n}\r\n.label::before {\r\n  position: absolute;\r\n  top: -1px;\r\n  right: -35px;\r\n  content: \"\";\r\n  width: 21px;\r\n  height: 21px;\r\n  background-color: rgb(37, 47, 107);\r\n  border: 1px solid rgb(163, 132, 31);\r\n  border-radius: 100%;\r\n  z-index: 1;\r\n  transition-duration: 400ms;\r\n}\r\n\r\n/* MAIN PAGE */\r\n.container {\r\n  position: relative;\r\n  display: flex;\r\n  flex-wrap: wrap;\r\n  justify-content: center;\r\n  margin: 30px auto 10px;\r\n  width: 80%;\r\n  min-height: 72vh;\r\n  align-content: baseline;\r\n}\r\n.category-name-wrapper {\r\n  display: flex;\r\n  position: fixed;\r\n  left: 0;\r\n  padding-bottom: 10px;\r\n  bottom: 50%;\r\n  transform: rotate(-90deg);\r\n}\r\n.category-name-wrapper span {\r\n  font-size: 2rem;\r\n  color: wheat;\r\n  text-align: center;\r\n}\r\n\r\n.card-wrapper {\r\n  position: relative;\r\n  width: 300px;\r\n  height: 240px;\r\n  display: flex;\r\n  margin: 15px 25px;\r\n  list-style-type: none;\r\n  text-decoration: none;\r\n  color: rgb(47, 74, 161);\r\n  box-shadow: 3px 3px 10px rgb(59, 56, 197);\r\n  perspective: 800px;\r\n  background: rgb(170, 38, 130);\r\n  border: 2px solid rgb(170, 38, 130);\r\n  border-radius: 15%;\r\n  transition: 1s;\r\n  overflow: hidden;\r\n  outline: none;\r\n  backface-visibility: hidden;\r\n}\r\n.card-wrapper:hover {\r\n  transform: skew(-3deg, 3deg);\r\n  transition: 0.3s;\r\n  cursor: default;\r\n}\r\n\r\n.front,\r\n.back {\r\n  position: absolute;\r\n  width: 100%;\r\n  height: auto;\r\n  border: none;\r\n  outline: none;\r\n  display: flex;\r\n  transition: 1s;\r\n  backface-visibility: hidden;\r\n  border-radius: 25%;\r\n  overflow: hidden;\r\n}\r\n.back {\r\n  transform: rotateY(180deg);\r\n}\r\n\r\n.front img,\r\n.back img {\r\n  width: 300px;\r\n  height: 210px;\r\n  overflow: hidden;\r\n}\r\n/* .front,\r\n.back img {\r\n  width: 100%;\r\n  height: auto;\r\n  overflow: hidden;\r\n} */\r\n\r\n.category-section {\r\n  position: absolute;\r\n  bottom: 0;\r\n  display: flex;\r\n  padding-top: 10px;\r\n  padding-bottom: 10px;\r\n  /* width: 300px; */\r\n  width: 100%;\r\n  height: 40px;\r\n  background-color: rgb(180, 146, 84);\r\n  align-items: center;\r\n  justify-content: center;\r\n  border-radius: 15%;\r\n  border: 1px solid rgb(170, 38, 130);\r\n  margin: 0 auto;\r\n}\r\n\r\n.card-name {\r\n  display: flex;\r\n  font-size: 2rem;\r\n  font-weight: bold;\r\n  text-shadow: 1px 1px rgb(12, 12, 12);\r\n  text-align: center;\r\n}\r\n\r\n.rotate-button {\r\n  position: absolute;\r\n  bottom: 20%;\r\n  right: 10%;\r\n  display: flex;\r\n  border: none;\r\n  padding: 0;\r\n  background-color: transparent;\r\n}\r\n\r\n.rotate-button img {\r\n  width: 40px;\r\n  height: 40px;\r\n}\r\n.rotate-button:hover {\r\n  transform: scaleX(-1);\r\n}\r\n.rotate-button:active,\r\n:focus {\r\n  outline-style: none;\r\n  outline-width: 0px !important;\r\n  outline-color: none !important;\r\n}\r\n.startgame-button {\r\n  position: absolute;\r\n  bottom: 20px;\r\n  display: flex;\r\n  justify-content: center;\r\n  width: 250px;\r\n  height: 50px;\r\n  background-color: wheat;\r\n  text-shadow: 1px 1px black;\r\n  color: #064b74;\r\n  font-weight: bold;\r\n  font-size: 2.5rem;\r\n  border-radius: 15px;\r\n  border: 3px solid #064b74;\r\n}\r\n.startgame-button:hover {\r\n  cursor: pointer;\r\n  background-color: rgb(250, 238, 216);\r\n  border: 1px solid #064b74;\r\n  box-shadow: 1px 1px 5px rgb(59, 56, 197);\r\n}\r\n\r\n.repeat-button__wrapper {\r\n  position: absolute;\r\n  bottom: 48%;\r\n  display: flex;\r\n  justify-content: center;\r\n  width: 80px;\r\n  height: 80px;\r\n  background-color: transparent;\r\n}\r\n.repeat-button:hover {\r\n  cursor: pointer;\r\n  transform: rotate(-90deg);\r\n  transition: 1.2s;\r\n}\r\n\r\n.repeat-button {\r\n  display: flex;\r\n  height: auto;\r\n  text-align: center;\r\n  background-color: transparent;\r\n  border: 0;\r\n  z-index: 2;\r\n}\r\n.repeat-button img {\r\n  width: 75px;\r\n}\r\n\r\n.star-wrapper {\r\n  display: flex;\r\n  flex-direction: row;\r\n  justify-content: flex-end;\r\n  width: 100%;\r\n  height: 50px;\r\n  /* border: 1px solid #064b74; */\r\n  overflow: hidden;\r\n}\r\n.star {\r\n  display: flex;\r\n}\r\n.result-wrapper {\r\n  display: flex;\r\n  flex-direction: column;\r\n  justify-content: center;\r\n  margin: 0 auto;\r\n  width: 400px;\r\n  height: 500px;\r\n  background-color: wheat;\r\n  border: 3px solid rgb(170, 38, 130);\r\n  border-radius: 15px;\r\n  overflow: hidden;\r\n}\r\n.result-wrapper span {\r\n  text-align: center;\r\n  font-size: 2.3rem;\r\n  font-weight: bold;\r\n  color: rgb(37, 59, 119);\r\n  margin-bottom: 10px;\r\n}\r\n.result-wrapper img {\r\n  background-color: transparent;\r\n}\r\n\r\n/* FOOTER */\r\n.footer-wrapper {\r\n  width: 100%;\r\n  height: 12vh;\r\n  background-color: rgb(8, 77, 42);\r\n}\r\n.footer {\r\n  width: 80%;\r\n  height: auto;\r\n  margin: 0 auto;\r\n  display: flex;\r\n  justify-content: space-around;\r\n  align-items: center;\r\n}\r\n.logo-wrapper {\r\n  display: flex;\r\n  margin-top: 2%;\r\n}\r\n.logo-wrapper a img {\r\n  width: 8rem;\r\n  height: 3rem;\r\n}\r\n\r\n.footer-link-course-wrapper {\r\n  display: flex;\r\n  text-align: center;\r\n  justify-content: center;\r\n}\r\n.footer-link {\r\n  display: flex;\r\n  list-style-type: none;\r\n  text-decoration: none;\r\n  color: white;\r\n  font-size: 1rem;\r\n  letter-spacing: 0.1rem;\r\n  margin: 20px 10px 10px;\r\n}\r\n.footer-link-color {\r\n  color: rgb(136, 130, 212);\r\n}\r\n.footer-information {\r\n  display: flex;\r\n  flex-direction: column;\r\n  text-align: center;\r\n}\r\n\r\n.year-wrapper {\r\n  display: flex;\r\n  justify-content: center;\r\n}\r\n.year-wrapper img {\r\n  width: 3.2rem;\r\n}\r\n\r\n@media screen and (min-width: 320px) and (max-width: 767px) {\r\n  .burger-menu_button {\r\n    top: 17%;\r\n    left: 10%;\r\n    width: 55px;\r\n    height: 55px;\r\n  }\r\n  .burger-menu_lines::before,\r\n  .burger-menu_lines::after,\r\n  .burger-menu_lines {\r\n    width: 35px;\r\n    height: 3.5px;\r\n    border-radius: 80%;\r\n  }\r\n  .selector-wrapper {\r\n    right: 25%;\r\n  }\r\n\r\n  /* MAIN PAGE */\r\n  .container {\r\n    width: 95%;\r\n    margin-bottom: 50px;\r\n  }\r\n\r\n  .card-wrapper {\r\n    margin-bottom: 15px;\r\n  }\r\n\r\n  .star-wrapper {\r\n    height: 35px;\r\n  }\r\n  .star img {\r\n    width: 30px;\r\n    height: 30px;\r\n  }\r\n\r\n  .startgame-button {\r\n    position: sticky;\r\n    width: 200px;\r\n    height: 50px;\r\n    font-size: 2rem;\r\n  }\r\n  .repeat-button__wrapper {\r\n    bottom: -65px;\r\n    z-index: 2;\r\n  }\r\n  .repeat-button img {\r\n    width: 50px;\r\n  }\r\n  .result-wrapper {\r\n    margin: 0 auto;\r\n    width: 90%;\r\n    height: auto;\r\n    border: 3px solid rgb(170, 38, 130);\r\n    border-radius: 15px;\r\n  }\r\n  .result-wrapper span {\r\n    font-size: 1.8rem;\r\n    margin-bottom: 10px;\r\n    margin-top: 10px;\r\n  }\r\n  .result-wrapper img {\r\n    width: 90%;\r\n    height: auto;\r\n  }\r\n\r\n  /* FOOTER */\r\n  .footer-wrapper {\r\n    height: 8vh;\r\n    padding-top: 20px;\r\n  }\r\n  .logo-wrapper {\r\n    margin-right: 10%;\r\n  }\r\n  .logo-wrapper a img {\r\n    width: 3rem;\r\n    height: 1.2rem;\r\n  }\r\n\r\n  .footer-link-course-wrapper {\r\n    width: 30%;\r\n  }\r\n  .footer-link {\r\n    font-size: 0.6rem;\r\n    margin: 0 5px;\r\n    padding: 0;\r\n  }\r\n  .footer-link-course {\r\n    transform: rotate(-12deg);\r\n  }\r\n  .footer-information {\r\n    margin-left: 7%;\r\n    margin-top: 1.5%;\r\n    flex-direction: column-reverse;\r\n  }\r\n  .year-wrapper img {\r\n    width: 1.6rem;\r\n  }\r\n}\r\n\r\n@media screen and (min-width: 500px) and (max-width: 767px) {\r\n  .logo-wrapper a img {\r\n    width: 3.3rem;\r\n    height: 1.5rem;\r\n  }\r\n  .container {\r\n    width: 95%;\r\n    margin-bottom: 60px;\r\n  }\r\n  .star-wrapper {\r\n    height: 40px;\r\n  }\r\n\r\n  .card-wrapper {\r\n    margin-left: 10px;\r\n    margin-right: 10px;\r\n  }\r\n  .startgame-button {\r\n    position: absolute;\r\n    bottom: -45px;\r\n    width: 200px;\r\n    height: 50px;\r\n    font-size: 2rem;\r\n  }\r\n  .footer-link {\r\n    font-size: 0.8rem;\r\n  }\r\n}\r\n\r\n@media screen and (min-width: 768px) and (max-width: 850px) {\r\n  .burger-menu_button {\r\n    top: 11%;\r\n    left: 15%;\r\n  }\r\n  .container {\r\n    width: 95%;\r\n    margin-bottom: 70px;\r\n  }\r\n  .startgame-button {\r\n    bottom: -55px;\r\n    width: 200px;\r\n    height: 50px;\r\n    font-size: 2rem;\r\n  }\r\n  .repeat-button__wrapper {\r\n    bottom: -73px;\r\n  }\r\n  .repeat-button img {\r\n    width: 50px;\r\n  }\r\n}\r\n\r\n@media screen and (min-width: 851px) and (max-width: 1280px) {\r\n  .burger-menu_button {\r\n    top: 11%;\r\n    left: 15%;\r\n  }\r\n  .container {\r\n    width: 90%;\r\n    margin-bottom: 60px;\r\n  }\r\n  .card-wrapper {\r\n    margin: 5px 30px;\r\n  }\r\n\r\n  .startgame-button {\r\n    bottom: -55px;\r\n    width: 250px;\r\n    height: 50px;\r\n    font-size: 2.2rem;\r\n  }\r\n  .repeat-button__wrapper {\r\n    bottom: -73px;\r\n  }\r\n  .repeat-button img {\r\n    width: 50px;\r\n  }\r\n}\r\n@media screen and (min-width: 1281px) and (max-width: 1600px) {\r\n  .container {\r\n    width: 95%;\r\n    margin-bottom: 60px;\r\n  }\r\n  .card-wrapper {\r\n    margin: 10px 15px;\r\n  }\r\n  .startgame-button {\r\n    bottom: -30px;\r\n    font-size: 2.5rem;\r\n  }\r\n  .repeat-button__wrapper {\r\n    bottom: -73px;\r\n  }\r\n  .repeat-button img {\r\n    width: 50px;\r\n  }\r\n}\r\n@media screen and (min-width: 1601px) and (max-width: 1900px) {\r\n  .container {\r\n    width: 90%;\r\n    margin-bottom: 60px;\r\n  }\r\n  .card-wrapper {\r\n    margin: 25px 25px;\r\n  }\r\n  .startgame-button {\r\n    bottom: -25px;\r\n    font-size: 2.5rem;\r\n    height: 60px;\r\n  }\r\n  .repeat-button__wrapper {\r\n    bottom: 250px;\r\n  }\r\n  .repeat-button img {\r\n    width: 70px;\r\n  }\r\n}\r\n", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;EACE,sBAAsB;EACtB,SAAS;EACT,UAAU;EACV,kCAAkC;AACpC;;AAEA,gBAAgB;AAChB;EACE,gBAAgB;AAClB;AACA;EACE,kBAAkB;EAClB,cAAc;EACd,WAAW;EACX,aAAa;EACb,8BAA8B;EAC9B,WAAW;EACX,YAAY;EACZ,gCAAgC;AAClC;;AAEA;EACE,kBAAkB;EAClB,QAAQ;EACR,SAAS;EACT,WAAW;EACX,WAAW;EACX,YAAY;EACZ,kBAAkB;EAClB,wCAAwC;EACxC,mCAAmC;AACrC;AACA;EACE,eAAe;EACf,yCAAyC;EACzC,kCAAkC;AACpC;AACA;;;EAGE,kBAAkB;EAClB,WAAW;EACX,WAAW;EACX,kBAAkB;EAClB,yBAAyB;AAC3B;AACA;EACE,QAAQ;EACR,SAAS;EACT,gCAAgC;AAClC;AACA;EACE,WAAW;EACX,UAAU;AACZ;AACA;EACE,WAAW;EACX,SAAS;AACX;AACA;EACE,6BAA6B;AAC/B;AACA;EACE,MAAM;EACN,wBAAwB;EACxB,gBAAgB;AAClB;AACA;EACE,MAAM;EACN,yBAAyB;EACzB,gBAAgB;AAClB;AACA;EACE,kBAAkB;EAClB,eAAe;EACf,MAAM;EACN,WAAW;EACX,aAAa;EACb,iBAAiB;EACjB,YAAY;EACZ,aAAa;EACb,yBAAyB;EACzB,mBAAmB;EACnB,gBAAgB;EAChB,WAAW;EACX,cAAc;AAChB;AACA;EACE,OAAO;EACP,yBAAyB;EACzB,gBAAgB;AAClB;;AAEA;EACE,kBAAkB;EAClB,eAAe;EACf,qBAAqB;EACrB,yBAAyB;EACzB,mBAAmB;EACnB,gBAAgB;EAChB,cAAc;AAChB;;AAEA;EACE,WAAW;EACX,eAAe;AACjB;AACA;EACE,yBAAyB;EACzB,eAAe;AACjB;AACA;EACE,aAAa;EACb,eAAe;EACf,MAAM;EACN,OAAO;EACP,YAAY;EACZ,aAAa;EACb,WAAW;AACb;AACA;EACE,cAAc;EACd,oCAAoC;AACtC;;AAEA,aAAa;AACb;EACE,kBAAkB;EAClB,SAAS;EACT,UAAU;EACV,WAAW;AACb;AACA;EACE,aAAa;AACf;AACA;EACE,YAAY;AACd;AACA;EACE,kBAAkB;EAClB,iBAAiB;EACjB,uBAAuB;EACvB,iBAAiB;EACjB,wBAAwB;EACxB,0BAA0B;EAC1B,eAAe;AACjB;AACA;EACE,kBAAkB;EAClB,SAAS;EACT,YAAY;EACZ,WAAW;EACX,WAAW;EACX,YAAY;EACZ,uBAAuB;EACvB,sBAAsB;EACtB,mBAAmB;AACrB;AACA;EACE,kBAAkB;EAClB,SAAS;EACT,YAAY;EACZ,WAAW;EACX,WAAW;EACX,YAAY;EACZ,kCAAkC;EAClC,mCAAmC;EACnC,mBAAmB;EACnB,UAAU;EACV,0BAA0B;AAC5B;;AAEA,cAAc;AACd;EACE,kBAAkB;EAClB,aAAa;EACb,eAAe;EACf,uBAAuB;EACvB,sBAAsB;EACtB,UAAU;EACV,gBAAgB;EAChB,uBAAuB;AACzB;AACA;EACE,aAAa;EACb,eAAe;EACf,OAAO;EACP,oBAAoB;EACpB,WAAW;EACX,yBAAyB;AAC3B;AACA;EACE,eAAe;EACf,YAAY;EACZ,kBAAkB;AACpB;;AAEA;EACE,kBAAkB;EAClB,YAAY;EACZ,aAAa;EACb,aAAa;EACb,iBAAiB;EACjB,qBAAqB;EACrB,qBAAqB;EACrB,uBAAuB;EACvB,yCAAyC;EACzC,kBAAkB;EAClB,6BAA6B;EAC7B,mCAAmC;EACnC,kBAAkB;EAClB,cAAc;EACd,gBAAgB;EAChB,aAAa;EACb,2BAA2B;AAC7B;AACA;EACE,4BAA4B;EAC5B,gBAAgB;EAChB,eAAe;AACjB;;AAEA;;EAEE,kBAAkB;EAClB,WAAW;EACX,YAAY;EACZ,YAAY;EACZ,aAAa;EACb,aAAa;EACb,cAAc;EACd,2BAA2B;EAC3B,kBAAkB;EAClB,gBAAgB;AAClB;AACA;EACE,0BAA0B;AAC5B;;AAEA;;EAEE,YAAY;EACZ,aAAa;EACb,gBAAgB;AAClB;AACA;;;;;GAKG;;AAEH;EACE,kBAAkB;EAClB,SAAS;EACT,aAAa;EACb,iBAAiB;EACjB,oBAAoB;EACpB,kBAAkB;EAClB,WAAW;EACX,YAAY;EACZ,mCAAmC;EACnC,mBAAmB;EACnB,uBAAuB;EACvB,kBAAkB;EAClB,mCAAmC;EACnC,cAAc;AAChB;;AAEA;EACE,aAAa;EACb,eAAe;EACf,iBAAiB;EACjB,oCAAoC;EACpC,kBAAkB;AACpB;;AAEA;EACE,kBAAkB;EAClB,WAAW;EACX,UAAU;EACV,aAAa;EACb,YAAY;EACZ,UAAU;EACV,6BAA6B;AAC/B;;AAEA;EACE,WAAW;EACX,YAAY;AACd;AACA;EACE,qBAAqB;AACvB;AACA;;EAEE,mBAAmB;EACnB,6BAA6B;EAC7B,8BAA8B;AAChC;AACA;EACE,kBAAkB;EAClB,YAAY;EACZ,aAAa;EACb,uBAAuB;EACvB,YAAY;EACZ,YAAY;EACZ,uBAAuB;EACvB,0BAA0B;EAC1B,cAAc;EACd,iBAAiB;EACjB,iBAAiB;EACjB,mBAAmB;EACnB,yBAAyB;AAC3B;AACA;EACE,eAAe;EACf,oCAAoC;EACpC,yBAAyB;EACzB,wCAAwC;AAC1C;;AAEA;EACE,kBAAkB;EAClB,WAAW;EACX,aAAa;EACb,uBAAuB;EACvB,WAAW;EACX,YAAY;EACZ,6BAA6B;AAC/B;AACA;EACE,eAAe;EACf,yBAAyB;EACzB,gBAAgB;AAClB;;AAEA;EACE,aAAa;EACb,YAAY;EACZ,kBAAkB;EAClB,6BAA6B;EAC7B,SAAS;EACT,UAAU;AACZ;AACA;EACE,WAAW;AACb;;AAEA;EACE,aAAa;EACb,mBAAmB;EACnB,yBAAyB;EACzB,WAAW;EACX,YAAY;EACZ,+BAA+B;EAC/B,gBAAgB;AAClB;AACA;EACE,aAAa;AACf;AACA;EACE,aAAa;EACb,sBAAsB;EACtB,uBAAuB;EACvB,cAAc;EACd,YAAY;EACZ,aAAa;EACb,uBAAuB;EACvB,mCAAmC;EACnC,mBAAmB;EACnB,gBAAgB;AAClB;AACA;EACE,kBAAkB;EAClB,iBAAiB;EACjB,iBAAiB;EACjB,uBAAuB;EACvB,mBAAmB;AACrB;AACA;EACE,6BAA6B;AAC/B;;AAEA,WAAW;AACX;EACE,WAAW;EACX,YAAY;EACZ,gCAAgC;AAClC;AACA;EACE,UAAU;EACV,YAAY;EACZ,cAAc;EACd,aAAa;EACb,6BAA6B;EAC7B,mBAAmB;AACrB;AACA;EACE,aAAa;EACb,cAAc;AAChB;AACA;EACE,WAAW;EACX,YAAY;AACd;;AAEA;EACE,aAAa;EACb,kBAAkB;EAClB,uBAAuB;AACzB;AACA;EACE,aAAa;EACb,qBAAqB;EACrB,qBAAqB;EACrB,YAAY;EACZ,eAAe;EACf,sBAAsB;EACtB,sBAAsB;AACxB;AACA;EACE,yBAAyB;AAC3B;AACA;EACE,aAAa;EACb,sBAAsB;EACtB,kBAAkB;AACpB;;AAEA;EACE,aAAa;EACb,uBAAuB;AACzB;AACA;EACE,aAAa;AACf;;AAEA;EACE;IACE,QAAQ;IACR,SAAS;IACT,WAAW;IACX,YAAY;EACd;EACA;;;IAGE,WAAW;IACX,aAAa;IACb,kBAAkB;EACpB;EACA;IACE,UAAU;EACZ;;EAEA,cAAc;EACd;IACE,UAAU;IACV,mBAAmB;EACrB;;EAEA;IACE,mBAAmB;EACrB;;EAEA;IACE,YAAY;EACd;EACA;IACE,WAAW;IACX,YAAY;EACd;;EAEA;IACE,gBAAgB;IAChB,YAAY;IACZ,YAAY;IACZ,eAAe;EACjB;EACA;IACE,aAAa;IACb,UAAU;EACZ;EACA;IACE,WAAW;EACb;EACA;IACE,cAAc;IACd,UAAU;IACV,YAAY;IACZ,mCAAmC;IACnC,mBAAmB;EACrB;EACA;IACE,iBAAiB;IACjB,mBAAmB;IACnB,gBAAgB;EAClB;EACA;IACE,UAAU;IACV,YAAY;EACd;;EAEA,WAAW;EACX;IACE,WAAW;IACX,iBAAiB;EACnB;EACA;IACE,iBAAiB;EACnB;EACA;IACE,WAAW;IACX,cAAc;EAChB;;EAEA;IACE,UAAU;EACZ;EACA;IACE,iBAAiB;IACjB,aAAa;IACb,UAAU;EACZ;EACA;IACE,yBAAyB;EAC3B;EACA;IACE,eAAe;IACf,gBAAgB;IAChB,8BAA8B;EAChC;EACA;IACE,aAAa;EACf;AACF;;AAEA;EACE;IACE,aAAa;IACb,cAAc;EAChB;EACA;IACE,UAAU;IACV,mBAAmB;EACrB;EACA;IACE,YAAY;EACd;;EAEA;IACE,iBAAiB;IACjB,kBAAkB;EACpB;EACA;IACE,kBAAkB;IAClB,aAAa;IACb,YAAY;IACZ,YAAY;IACZ,eAAe;EACjB;EACA;IACE,iBAAiB;EACnB;AACF;;AAEA;EACE;IACE,QAAQ;IACR,SAAS;EACX;EACA;IACE,UAAU;IACV,mBAAmB;EACrB;EACA;IACE,aAAa;IACb,YAAY;IACZ,YAAY;IACZ,eAAe;EACjB;EACA;IACE,aAAa;EACf;EACA;IACE,WAAW;EACb;AACF;;AAEA;EACE;IACE,QAAQ;IACR,SAAS;EACX;EACA;IACE,UAAU;IACV,mBAAmB;EACrB;EACA;IACE,gBAAgB;EAClB;;EAEA;IACE,aAAa;IACb,YAAY;IACZ,YAAY;IACZ,iBAAiB;EACnB;EACA;IACE,aAAa;EACf;EACA;IACE,WAAW;EACb;AACF;AACA;EACE;IACE,UAAU;IACV,mBAAmB;EACrB;EACA;IACE,iBAAiB;EACnB;EACA;IACE,aAAa;IACb,iBAAiB;EACnB;EACA;IACE,aAAa;EACf;EACA;IACE,WAAW;EACb;AACF;AACA;EACE;IACE,UAAU;IACV,mBAAmB;EACrB;EACA;IACE,iBAAiB;EACnB;EACA;IACE,aAAa;IACb,iBAAiB;IACjB,YAAY;EACd;EACA;IACE,aAAa;EACf;EACA;IACE,WAAW;EACb;AACF","sourcesContent":["body {\r\n  box-sizing: border-box;\r\n  margin: 0;\r\n  padding: 0;\r\n  background-color: rgb(42, 134, 99);\r\n}\r\n\r\n/* Burger-menu */\r\n.lock {\r\n  overflow: hidden;\r\n}\r\n.header-wrapper {\r\n  position: relative;\r\n  margin: 0 auto;\r\n  z-index: 50;\r\n  display: flex;\r\n  justify-content: space-between;\r\n  width: 100%;\r\n  height: 12vh;\r\n  background-color: rgb(8, 77, 42);\r\n}\r\n\r\n.burger-menu_button {\r\n  position: absolute;\r\n  top: 13%;\r\n  left: 17%;\r\n  z-index: 20;\r\n  width: 80px;\r\n  height: 80px;\r\n  border-radius: 50%;\r\n  background-color: rgba(31, 168, 84, 0.5);\r\n  border: 1px solid rgb(16, 122, 126);\r\n}\r\n.burger-menu_button:hover {\r\n  cursor: pointer;\r\n  background-color: rgba(201, 211, 64, 0.7);\r\n  border: 1px solid rgb(10, 34, 110);\r\n}\r\n.burger-menu_lines::before,\r\n.burger-menu_lines::after,\r\n.burger-menu_lines {\r\n  position: absolute;\r\n  width: 50px;\r\n  height: 5px;\r\n  border-radius: 80%;\r\n  background-color: #1e2ebb;\r\n}\r\n.burger-menu_lines {\r\n  top: 50%;\r\n  left: 50%;\r\n  transform: translate(-50%, -50%);\r\n}\r\n.burger-menu_lines::before {\r\n  content: \"\";\r\n  top: -12px;\r\n}\r\n.burger-menu_lines::after {\r\n  content: \"\";\r\n  top: 12px;\r\n}\r\n.burger-menu_active .burger-menu_lines {\r\n  background-color: transparent;\r\n}\r\n.burger-menu_active .burger-menu_lines::before {\r\n  top: 0;\r\n  transform: rotate(45deg);\r\n  transition: 0.6s;\r\n}\r\n.burger-menu_active .burger-menu_lines::after {\r\n  top: 0;\r\n  transform: rotate(-45deg);\r\n  transition: 0.6s;\r\n}\r\n.burger-nav {\r\n  padding-top: 115px;\r\n  position: fixed;\r\n  top: 0;\r\n  z-index: 12;\r\n  display: flex;\r\n  flex-flow: column;\r\n  width: 300px;\r\n  height: 100vh;\r\n  background-color: #064b74;\r\n  border-radius: 10px;\r\n  overflow-y: auto;\r\n  left: -100%;\r\n  transition: 1s;\r\n}\r\n.burger-menu_active .burger-nav {\r\n  left: 0;\r\n  transform: rotate(720deg);\r\n  transition: 0.8s;\r\n}\r\n\r\n.burger-nav_link {\r\n  padding: 18px 35px;\r\n  font-size: 18px;\r\n  text-decoration: none;\r\n  text-transform: uppercase;\r\n  letter-spacing: 5px;\r\n  font-weight: 400;\r\n  color: #ffffff;\r\n}\r\n\r\n.burger-nav_link-active {\r\n  color: gold;\r\n  cursor: pointer;\r\n}\r\n.burger-nav_link:hover {\r\n  color: rgb(113, 171, 204);\r\n  cursor: pointer;\r\n}\r\n.burger-menu_overlay {\r\n  display: none;\r\n  position: fixed;\r\n  top: 0;\r\n  left: 0;\r\n  width: 100vw;\r\n  height: 100vh;\r\n  z-index: 10;\r\n}\r\n.burger-menu_active .burger-menu_overlay {\r\n  display: block;\r\n  background-color: rgba(0, 0, 0, 0.5);\r\n}\r\n\r\n/* Selector */\r\n.selector-wrapper {\r\n  position: absolute;\r\n  top: 42px;\r\n  right: 20%;\r\n  width: auto;\r\n}\r\n.input {\r\n  display: none;\r\n}\r\n.input:checked + .label::before {\r\n  right: -60px;\r\n}\r\n.label {\r\n  position: relative;\r\n  font-size: 1.5rem;\r\n  letter-spacing: 0.18rem;\r\n  font-weight: bold;\r\n  color: rgb(170, 38, 130);\r\n  text-shadow: 1px 1px black;\r\n  cursor: pointer;\r\n}\r\n.label::after {\r\n  position: absolute;\r\n  top: -4px;\r\n  right: -62px;\r\n  content: \"\";\r\n  width: 50px;\r\n  height: 25px;\r\n  background-color: wheat;\r\n  border: 1px solid blue;\r\n  border-radius: 15px;\r\n}\r\n.label::before {\r\n  position: absolute;\r\n  top: -1px;\r\n  right: -35px;\r\n  content: \"\";\r\n  width: 21px;\r\n  height: 21px;\r\n  background-color: rgb(37, 47, 107);\r\n  border: 1px solid rgb(163, 132, 31);\r\n  border-radius: 100%;\r\n  z-index: 1;\r\n  transition-duration: 400ms;\r\n}\r\n\r\n/* MAIN PAGE */\r\n.container {\r\n  position: relative;\r\n  display: flex;\r\n  flex-wrap: wrap;\r\n  justify-content: center;\r\n  margin: 30px auto 10px;\r\n  width: 80%;\r\n  min-height: 72vh;\r\n  align-content: baseline;\r\n}\r\n.category-name-wrapper {\r\n  display: flex;\r\n  position: fixed;\r\n  left: 0;\r\n  padding-bottom: 10px;\r\n  bottom: 50%;\r\n  transform: rotate(-90deg);\r\n}\r\n.category-name-wrapper span {\r\n  font-size: 2rem;\r\n  color: wheat;\r\n  text-align: center;\r\n}\r\n\r\n.card-wrapper {\r\n  position: relative;\r\n  width: 300px;\r\n  height: 240px;\r\n  display: flex;\r\n  margin: 15px 25px;\r\n  list-style-type: none;\r\n  text-decoration: none;\r\n  color: rgb(47, 74, 161);\r\n  box-shadow: 3px 3px 10px rgb(59, 56, 197);\r\n  perspective: 800px;\r\n  background: rgb(170, 38, 130);\r\n  border: 2px solid rgb(170, 38, 130);\r\n  border-radius: 15%;\r\n  transition: 1s;\r\n  overflow: hidden;\r\n  outline: none;\r\n  backface-visibility: hidden;\r\n}\r\n.card-wrapper:hover {\r\n  transform: skew(-3deg, 3deg);\r\n  transition: 0.3s;\r\n  cursor: default;\r\n}\r\n\r\n.front,\r\n.back {\r\n  position: absolute;\r\n  width: 100%;\r\n  height: auto;\r\n  border: none;\r\n  outline: none;\r\n  display: flex;\r\n  transition: 1s;\r\n  backface-visibility: hidden;\r\n  border-radius: 25%;\r\n  overflow: hidden;\r\n}\r\n.back {\r\n  transform: rotateY(180deg);\r\n}\r\n\r\n.front img,\r\n.back img {\r\n  width: 300px;\r\n  height: 210px;\r\n  overflow: hidden;\r\n}\r\n/* .front,\r\n.back img {\r\n  width: 100%;\r\n  height: auto;\r\n  overflow: hidden;\r\n} */\r\n\r\n.category-section {\r\n  position: absolute;\r\n  bottom: 0;\r\n  display: flex;\r\n  padding-top: 10px;\r\n  padding-bottom: 10px;\r\n  /* width: 300px; */\r\n  width: 100%;\r\n  height: 40px;\r\n  background-color: rgb(180, 146, 84);\r\n  align-items: center;\r\n  justify-content: center;\r\n  border-radius: 15%;\r\n  border: 1px solid rgb(170, 38, 130);\r\n  margin: 0 auto;\r\n}\r\n\r\n.card-name {\r\n  display: flex;\r\n  font-size: 2rem;\r\n  font-weight: bold;\r\n  text-shadow: 1px 1px rgb(12, 12, 12);\r\n  text-align: center;\r\n}\r\n\r\n.rotate-button {\r\n  position: absolute;\r\n  bottom: 20%;\r\n  right: 10%;\r\n  display: flex;\r\n  border: none;\r\n  padding: 0;\r\n  background-color: transparent;\r\n}\r\n\r\n.rotate-button img {\r\n  width: 40px;\r\n  height: 40px;\r\n}\r\n.rotate-button:hover {\r\n  transform: scaleX(-1);\r\n}\r\n.rotate-button:active,\r\n:focus {\r\n  outline-style: none;\r\n  outline-width: 0px !important;\r\n  outline-color: none !important;\r\n}\r\n.startgame-button {\r\n  position: absolute;\r\n  bottom: 20px;\r\n  display: flex;\r\n  justify-content: center;\r\n  width: 250px;\r\n  height: 50px;\r\n  background-color: wheat;\r\n  text-shadow: 1px 1px black;\r\n  color: #064b74;\r\n  font-weight: bold;\r\n  font-size: 2.5rem;\r\n  border-radius: 15px;\r\n  border: 3px solid #064b74;\r\n}\r\n.startgame-button:hover {\r\n  cursor: pointer;\r\n  background-color: rgb(250, 238, 216);\r\n  border: 1px solid #064b74;\r\n  box-shadow: 1px 1px 5px rgb(59, 56, 197);\r\n}\r\n\r\n.repeat-button__wrapper {\r\n  position: absolute;\r\n  bottom: 48%;\r\n  display: flex;\r\n  justify-content: center;\r\n  width: 80px;\r\n  height: 80px;\r\n  background-color: transparent;\r\n}\r\n.repeat-button:hover {\r\n  cursor: pointer;\r\n  transform: rotate(-90deg);\r\n  transition: 1.2s;\r\n}\r\n\r\n.repeat-button {\r\n  display: flex;\r\n  height: auto;\r\n  text-align: center;\r\n  background-color: transparent;\r\n  border: 0;\r\n  z-index: 2;\r\n}\r\n.repeat-button img {\r\n  width: 75px;\r\n}\r\n\r\n.star-wrapper {\r\n  display: flex;\r\n  flex-direction: row;\r\n  justify-content: flex-end;\r\n  width: 100%;\r\n  height: 50px;\r\n  /* border: 1px solid #064b74; */\r\n  overflow: hidden;\r\n}\r\n.star {\r\n  display: flex;\r\n}\r\n.result-wrapper {\r\n  display: flex;\r\n  flex-direction: column;\r\n  justify-content: center;\r\n  margin: 0 auto;\r\n  width: 400px;\r\n  height: 500px;\r\n  background-color: wheat;\r\n  border: 3px solid rgb(170, 38, 130);\r\n  border-radius: 15px;\r\n  overflow: hidden;\r\n}\r\n.result-wrapper span {\r\n  text-align: center;\r\n  font-size: 2.3rem;\r\n  font-weight: bold;\r\n  color: rgb(37, 59, 119);\r\n  margin-bottom: 10px;\r\n}\r\n.result-wrapper img {\r\n  background-color: transparent;\r\n}\r\n\r\n/* FOOTER */\r\n.footer-wrapper {\r\n  width: 100%;\r\n  height: 12vh;\r\n  background-color: rgb(8, 77, 42);\r\n}\r\n.footer {\r\n  width: 80%;\r\n  height: auto;\r\n  margin: 0 auto;\r\n  display: flex;\r\n  justify-content: space-around;\r\n  align-items: center;\r\n}\r\n.logo-wrapper {\r\n  display: flex;\r\n  margin-top: 2%;\r\n}\r\n.logo-wrapper a img {\r\n  width: 8rem;\r\n  height: 3rem;\r\n}\r\n\r\n.footer-link-course-wrapper {\r\n  display: flex;\r\n  text-align: center;\r\n  justify-content: center;\r\n}\r\n.footer-link {\r\n  display: flex;\r\n  list-style-type: none;\r\n  text-decoration: none;\r\n  color: white;\r\n  font-size: 1rem;\r\n  letter-spacing: 0.1rem;\r\n  margin: 20px 10px 10px;\r\n}\r\n.footer-link-color {\r\n  color: rgb(136, 130, 212);\r\n}\r\n.footer-information {\r\n  display: flex;\r\n  flex-direction: column;\r\n  text-align: center;\r\n}\r\n\r\n.year-wrapper {\r\n  display: flex;\r\n  justify-content: center;\r\n}\r\n.year-wrapper img {\r\n  width: 3.2rem;\r\n}\r\n\r\n@media screen and (min-width: 320px) and (max-width: 767px) {\r\n  .burger-menu_button {\r\n    top: 17%;\r\n    left: 10%;\r\n    width: 55px;\r\n    height: 55px;\r\n  }\r\n  .burger-menu_lines::before,\r\n  .burger-menu_lines::after,\r\n  .burger-menu_lines {\r\n    width: 35px;\r\n    height: 3.5px;\r\n    border-radius: 80%;\r\n  }\r\n  .selector-wrapper {\r\n    right: 25%;\r\n  }\r\n\r\n  /* MAIN PAGE */\r\n  .container {\r\n    width: 95%;\r\n    margin-bottom: 50px;\r\n  }\r\n\r\n  .card-wrapper {\r\n    margin-bottom: 15px;\r\n  }\r\n\r\n  .star-wrapper {\r\n    height: 35px;\r\n  }\r\n  .star img {\r\n    width: 30px;\r\n    height: 30px;\r\n  }\r\n\r\n  .startgame-button {\r\n    position: sticky;\r\n    width: 200px;\r\n    height: 50px;\r\n    font-size: 2rem;\r\n  }\r\n  .repeat-button__wrapper {\r\n    bottom: -65px;\r\n    z-index: 2;\r\n  }\r\n  .repeat-button img {\r\n    width: 50px;\r\n  }\r\n  .result-wrapper {\r\n    margin: 0 auto;\r\n    width: 90%;\r\n    height: auto;\r\n    border: 3px solid rgb(170, 38, 130);\r\n    border-radius: 15px;\r\n  }\r\n  .result-wrapper span {\r\n    font-size: 1.8rem;\r\n    margin-bottom: 10px;\r\n    margin-top: 10px;\r\n  }\r\n  .result-wrapper img {\r\n    width: 90%;\r\n    height: auto;\r\n  }\r\n\r\n  /* FOOTER */\r\n  .footer-wrapper {\r\n    height: 8vh;\r\n    padding-top: 20px;\r\n  }\r\n  .logo-wrapper {\r\n    margin-right: 10%;\r\n  }\r\n  .logo-wrapper a img {\r\n    width: 3rem;\r\n    height: 1.2rem;\r\n  }\r\n\r\n  .footer-link-course-wrapper {\r\n    width: 30%;\r\n  }\r\n  .footer-link {\r\n    font-size: 0.6rem;\r\n    margin: 0 5px;\r\n    padding: 0;\r\n  }\r\n  .footer-link-course {\r\n    transform: rotate(-12deg);\r\n  }\r\n  .footer-information {\r\n    margin-left: 7%;\r\n    margin-top: 1.5%;\r\n    flex-direction: column-reverse;\r\n  }\r\n  .year-wrapper img {\r\n    width: 1.6rem;\r\n  }\r\n}\r\n\r\n@media screen and (min-width: 500px) and (max-width: 767px) {\r\n  .logo-wrapper a img {\r\n    width: 3.3rem;\r\n    height: 1.5rem;\r\n  }\r\n  .container {\r\n    width: 95%;\r\n    margin-bottom: 60px;\r\n  }\r\n  .star-wrapper {\r\n    height: 40px;\r\n  }\r\n\r\n  .card-wrapper {\r\n    margin-left: 10px;\r\n    margin-right: 10px;\r\n  }\r\n  .startgame-button {\r\n    position: absolute;\r\n    bottom: -45px;\r\n    width: 200px;\r\n    height: 50px;\r\n    font-size: 2rem;\r\n  }\r\n  .footer-link {\r\n    font-size: 0.8rem;\r\n  }\r\n}\r\n\r\n@media screen and (min-width: 768px) and (max-width: 850px) {\r\n  .burger-menu_button {\r\n    top: 11%;\r\n    left: 15%;\r\n  }\r\n  .container {\r\n    width: 95%;\r\n    margin-bottom: 70px;\r\n  }\r\n  .startgame-button {\r\n    bottom: -55px;\r\n    width: 200px;\r\n    height: 50px;\r\n    font-size: 2rem;\r\n  }\r\n  .repeat-button__wrapper {\r\n    bottom: -73px;\r\n  }\r\n  .repeat-button img {\r\n    width: 50px;\r\n  }\r\n}\r\n\r\n@media screen and (min-width: 851px) and (max-width: 1280px) {\r\n  .burger-menu_button {\r\n    top: 11%;\r\n    left: 15%;\r\n  }\r\n  .container {\r\n    width: 90%;\r\n    margin-bottom: 60px;\r\n  }\r\n  .card-wrapper {\r\n    margin: 5px 30px;\r\n  }\r\n\r\n  .startgame-button {\r\n    bottom: -55px;\r\n    width: 250px;\r\n    height: 50px;\r\n    font-size: 2.2rem;\r\n  }\r\n  .repeat-button__wrapper {\r\n    bottom: -73px;\r\n  }\r\n  .repeat-button img {\r\n    width: 50px;\r\n  }\r\n}\r\n@media screen and (min-width: 1281px) and (max-width: 1600px) {\r\n  .container {\r\n    width: 95%;\r\n    margin-bottom: 60px;\r\n  }\r\n  .card-wrapper {\r\n    margin: 10px 15px;\r\n  }\r\n  .startgame-button {\r\n    bottom: -30px;\r\n    font-size: 2.5rem;\r\n  }\r\n  .repeat-button__wrapper {\r\n    bottom: -73px;\r\n  }\r\n  .repeat-button img {\r\n    width: 50px;\r\n  }\r\n}\r\n@media screen and (min-width: 1601px) and (max-width: 1900px) {\r\n  .container {\r\n    width: 90%;\r\n    margin-bottom: 60px;\r\n  }\r\n  .card-wrapper {\r\n    margin: 25px 25px;\r\n  }\r\n  .startgame-button {\r\n    bottom: -25px;\r\n    font-size: 2.5rem;\r\n    height: 60px;\r\n  }\r\n  .repeat-button__wrapper {\r\n    bottom: 250px;\r\n  }\r\n  .repeat-button img {\r\n    width: 70px;\r\n  }\r\n}\r\n"],"sourceRoot":""}]);
// Exports
